...
> 최종 업데이트: 2026-02-09
> 현재 단계: **Phase 3 Webview (Next.js) 시작 준비**
...
- [x] x-api-key 인증 미들웨어
- [x] 오픈빌더 UI 설정 (스킬 서버 URL, 폴백 블록 스킬데이터, 콜백 활성화)
...
- [x] 실환경 테스트 — ngrok + 오픈빌더 연결, 콜백 응답 확인 완료
...
| 2026-02-10 | Phase 2 실환경 디버깅 | ADK 세션 복구, 콜백 연동, 프로필 자동 로드 | 프롬프트 튜닝, 패닉 복구, 로그 정리 |
| | | | |
